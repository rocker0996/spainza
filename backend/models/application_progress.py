...
class ApplicationProgress:
    ...
    STAGES_BY_TYPE = {
        ...
        "business_immigration": [
            ...
            },
            {
                ...
                "description_ru": "Подача на бизнес-визу или ВНЖ",
    ...
    def get_stages_for_type(application_type: str) -> List[ApplicationStage]:
        ...
        stage_templates = ApplicationProgress.STAGES_BY_TYPE.get(
            application_type,
            ApplicationProgress.STAGES_BY_TYPE["vnj_investment"],
        )
    ...
    def create_progress(
        ...
        progress_percentage = int((completed_stages / total_stages) * 100) if total_stages else 0
    ...
    @staticmethod
    def update_progress(progress_data: Dict, new_stage_id: str) -> Dict:
        """Update progress to a new stage."""
        stages = [ApplicationStage(**stage_dict) for stage_dict in progress_data["stages"]]
