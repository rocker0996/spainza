...
(function (global) {
  ...
  var STRINGS = {
    ru: {
      ...
      "notes.subtitle": "Заметки, риски и рабочий чеклист по клиенту. Клиент не видит этот раздел.",
      ...
      "notes.risksTitle": "Риски и контроль",
      "notes.risksLead": "Всё, что может повлиять на сроки, документы или коммуникацию.",
      "notes.priorityLabel": "Приоритет",
      "notes.priority.low": "Низкий",
      "notes.priority.normal": "Обычный",
      "notes.priority.high": "Высокий",
      "notes.priority.urgent": "Срочный",
      "notes.nextContactLabel": "Следующий контакт",
      "notes.riskLabel": "Риски",
      "notes.riskPlaceholder": "Например: нужен свежий банковский документ.",
    ...
    en: {
      ...
      "notes.subtitle": "Client notes, risks, and staff checklist. The client cannot see this section.",
      ...
      "notes.risksTitle": "Risks and control",
      "notes.risksLead": "Anything that can affect timing, documents, or communication.",
      ...
      "notes.nextContactLabel": "Next contact",
      "notes.riskLabel": "Risks",
      "notes.riskPlaceholder": "For example: a fresh bank document is required.",
