...
(function (global) {
  ...
  var STRINGS = {
    ru: {
      ...
      "dashboard.residenceApproved": "ВНЖ одобрен",
      "dashboard.caseCompletedNote": "Кейс успешно завершён.",
      ...
      "dashboard.staffQuickActions": "Быстрые действия",
      "dashboard.staffOpenClients": "Открыть клиентов",
      "dashboard.staffOpenMessages": "Открыть сообщения",
      "dashboard.staffOpenTemplates": "Настроить шаблоны",
      ...
      "documents.caseCompletedTitle": "Кейс успешно завершён",
      "documents.caseCompletedCleanupDays": "Файлы этого кейса будут удалены через {n} дн.",
      "documents.caseCompletedCleanupSoon": "Срок хранения файлов истёк. Файлы будут очищены при ближайшей автоматической очистке.",
      ...
      "case.history.consulateDateChanged": "Изменена дата подачи",
      ...
      "case.history.internalNotesUpdated": "Внутренние заметки обновлены",
      ...
      "clients.nameCol": "Имя",
      "clients.sortRole": "Кейс",
      "clients.sortConsulate": "Дата подачи",
      ...
      "clients.internalNotes": "Внутренние заметки",
      "clients.caseBtn": "Кейс",
      "clients.docsBtn": "Документы",
      "clients.notesBtn": "Заметки",
      "clients.consulateCol": "Дата подачи",
      "clients.statusCol": "Статус",
      "clients.completedTitle": "Завершенные кейсы",
      "clients.completedLead": "Клиенты, у которых отмечено получение ВНЖ.",
      "clients.completedStatus": "Завершено",
      "clients.registrationCol": "Дата регистрации",
      "notes.pageTitle": "Внутренние заметки | Spainza",
      "notes.title": "Внутренние заметки",
      "notes.subtitle": "Заметки, финансовые условия и рабочий чеклист по клиенту. Клиент не видит этот раздел.",
      "notes.internalOnly": "Только для команды",
      "notes.save": "Сохранить",
      "notes.loading": "Загрузка заметок...",
      "notes.loadFailed": "Не удалось загрузить внутренние заметки",
      "notes.saved": "Заметки сохранены",
      "notes.saveFailed": "Не удалось сохранить заметки",
      "notes.unsaved": "Есть изменения",
      "notes.managerNotes": "Заметки менеджера",
      "notes.managerNotesLead": "Короткий контекст, договорённости и важные детали общения.",
      "notes.financialTitle": "Финансовые условия",
      "notes.financialLead": "Внутренние договорённости по стоимости и оплате кейса.",
      "notes.casePrice": "Цена кейса",
      "notes.casePricePlaceholder": "Например: 2500 EUR",
      "notes.paymentModel": "Модель оплаты",
      "notes.paymentModelPlaceholder": "Например: 50/50",
      "notes.amountPaid": "Уже оплачено",
      "notes.amountPaidPlaceholder": "Например: 1000 EUR, 29.06",
      "notes.addNoteLabel": "Новая заметка",
      "notes.addNotePlaceholder": "Добавьте рабочую заметку по клиенту...",
      "notes.addNoteHint": "Заметка сохранится после нажатия «Сохранить».",
      "notes.addNote": "Добавить",
      "notes.emptyNotes": "Заметок пока нет",
      "notes.noteCardTitle": "Заметка #{n}",
      "notes.generalLabel": "Общие заметки",
      "notes.paymentLabel": "Оплата и условия",
      "notes.paymentPlaceholder": "Например: 50/50, второй платеж после записи.",
      "notes.checklistTitle": "Внутренний чеклист",
      "notes.checklistLead": "Рабочие пункты, которые видит только команда.",
      "notes.addChecklistPlaceholder": "Новый пункт",
      "notes.historyTitle": "История кейса",
      "notes.historyLoading": "Загрузка истории...",
      ...
      "chat.photos": "Фото",
      "chat.photosCount": "Фото ({count})",
      "chat.photosModalTitle": "Фото чата",
      "chat.photosModalSubtitle": "Изображения, отправленные в этой переписке",
      "chat.photosEmpty": "В этом чате пока нет фото",
      "chat.photosSelectChat": "Сначала выберите чат",
      "chat.closePhotos": "Закрыть фото",
      ...
      "configurator.fieldDuration": "Срок",
      "configurator.durationPlaceholder": "1 нед.",
      ...
      "configurator.needStepTitle": "У каждого этапа должно быть название",
      "configurator.needDocName": "У каждого документа должно быть название",
      "configurator.invalidPriority": "Выбран неверный приоритет документа",
      ...
      "case.consulateDate": "Дата подачи",
    ...
    en: {
      ...
      "dashboard.residenceApproved": "Residence permit approved",
      "dashboard.caseCompletedNote": "The case has been completed successfully.",
      ...
      "dashboard.staffQuickActions": "Quick actions",
      "dashboard.staffOpenClients": "Open clients",
      "dashboard.staffOpenMessages": "Open messages",
      "dashboard.staffOpenTemplates": "Configure templates",
      ...
      "documents.caseCompletedTitle": "Case completed successfully",
      "documents.caseCompletedCleanupDays": "Files for this case will be deleted in {n} day(s).",
      "documents.caseCompletedCleanupSoon": "The file retention period has expired. Files will be cleaned during the next automatic cleanup.",
      ...
      "case.history.consulateDateChanged": "Submission date changed",
      ...
      "case.history.internalNotesUpdated": "Internal notes updated",
      ...
      "clients.nameCol": "Name",
      "clients.sortRole": "Case",
      "clients.sortConsulate": "Submission date",
      ...
      "clients.notesBtn": "Notes",
      "clients.consulateCol": "Submission date",
      "clients.statusCol": "Status",
      "clients.completedTitle": "Completed cases",
      "clients.completedLead": "Clients marked as having received their residence permit.",
      "clients.completedStatus": "Completed",
      "clients.registrationCol": "Registration date",
      "notes.pageTitle": "Internal notes | Spainza",
      "notes.title": "Internal notes",
      "notes.subtitle": "Client notes, financial terms, and staff checklist. The client cannot see this section.",
      "notes.internalOnly": "Team only",
      "notes.save": "Save",
      "notes.loading": "Loading notes...",
      "notes.loadFailed": "Could not load internal notes",
      "notes.saved": "Notes saved",
      "notes.saveFailed": "Could not save notes",
      "notes.unsaved": "Unsaved changes",
      "notes.managerNotes": "Manager notes",
      "notes.managerNotesLead": "Short context, agreements, and important communication details.",
      "notes.financialTitle": "Financial terms",
      "notes.financialLead": "Internal agreements on case price and payments.",
      "notes.casePrice": "Case price",
      "notes.casePricePlaceholder": "For example: 2500 EUR",
      "notes.paymentModel": "Payment model",
      "notes.paymentModelPlaceholder": "For example: 50/50",
      "notes.amountPaid": "Already paid",
      "notes.amountPaidPlaceholder": "For example: 1000 EUR, Jun 29",
      "notes.addNoteLabel": "New note",
      "notes.addNotePlaceholder": "Add an internal working note for this client...",
      "notes.addNoteHint": "The note is stored after you press Save.",
      "notes.addNote": "Add",
      "notes.emptyNotes": "No notes yet",
      "notes.noteCardTitle": "Note #{n}",
      "notes.generalLabel": "General notes",
      "notes.paymentLabel": "Payment and terms",
      "notes.paymentPlaceholder": "For example: 50/50, second payment after appointment.",
      "notes.checklistTitle": "Internal checklist",
      "notes.checklistLead": "Staff-only working items.",
      "notes.addChecklistPlaceholder": "New item",
      "notes.historyTitle": "Case history",
      ...
      "chat.photos": "Photos",
      "chat.photosCount": "Photos ({count})",
      "chat.photosModalTitle": "Chat photos",
      "chat.photosModalSubtitle": "Images shared in this conversation",
      "chat.photosEmpty": "No photos in this chat yet",
      "chat.photosSelectChat": "Select a chat first",
      "chat.closePhotos": "Close photos",
      ...
      "configurator.fieldDuration": "Duration",
      "configurator.durationPlaceholder": "1 week",
      ...
      "configurator.needStepTitle": "Each stage needs a title",
      "configurator.needDocName": "Each document needs a name",
      "configurator.invalidPriority": "Invalid document priority",
      ...
      "case.consulateDate": "Submission date",
  ...
  function translateCaseHistoryAction(action) {
    ...
    var map = {
      ...
      "Изменена дата подачи": t("case.history.consulateDateChanged"),
      ...
      "Внутренние заметки обновлены": t("case.history.internalNotesUpdated"),
    };
    return map[raw] || raw;
  }
