...
(function (global) {
  ...
  var STRINGS = {
    ru: {
      ...
      "dashboard.caseCompletedNote": "Кейс успешно завершён. Блок статуса подсвечен как завершенный.",
    ...
    en: {
      ...
      "dashboard.caseCompletedNote": "The case has been completed successfully. The status card is highlighted as complete.",
