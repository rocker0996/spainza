...
(function (global) {
  ...
  var STRINGS = {
    ru: {
      ...
      "login.googleError": "Не удалось войти через Google. Проверьте настройки и попробуйте снова.",
      ...
      "login.telegramOpen": "Открыть Telegram",
    ...
    en: {
      ...
      "login.googleError": "Could not sign in with Google. Check the settings and try again.",
      "login.telegram": "Telegram",
      ...
      "login.telegramOpen": "Open Telegram",
